...
class EditMenu(BaseMenu):
    ...
    def create_question(storage):
        ...
        storage.max_id += 1
        storage.save_questions(Question(id = None, text = text, answers = answers))
        ...
        if conf == 'y':
            ...
            for question in storage.questions:
                if question.id == selected_id:
                    storage.delete_question(selected_id)
...
class EditQuestion(BaseMenu):
    ...
    def new_text(self):
        ...
        print(self.question)
        self.storage.update_question(self.question)
    ...
    def reset_statistics(self):
        ...
        self.storage.save_question_statistics(self.question)
